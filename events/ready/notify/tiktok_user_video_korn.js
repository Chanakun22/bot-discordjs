...
//     try {
//         const SEC_UID = "MS4wLjABAAAAIirjlzb2JndzJyjzP8H03csQ8dw3wsYCsa1SIoSAZYnpvOzU2a6BAb0ycfE-aTv4";
...
//                     if (!existingVideo) {
//                         const channel = client.channels.cache.get('1251430293189951529');
...
//             };
//             const { data } = await axios.get(signed_url, { headers });
//             return { data };
//         }
